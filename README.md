...
| **Hand Controlled Media Player** | Gesture-based media control interface using OpenCV + MediaPipe for play, pause, and volume control with real-time hand tracking. | <a><href="https://github.com/manubarikar/Hand-Controlled-Media-Player"> Repository </a>  | — |
